function compute()
{
    ...
    var amount = interest + principal; //This declares the variable "amount" which is the sum of the prinicipal and the interest
    ...
    document.getElementById("result").innerHTML="If you deposit <mark>"+principal+"</mark>,\<br\>at an interest rate of <mark>"+rate+"%</mark>\<br\>You will receive an amount of <mark>"+amount+"</mark>,\<br\>in the year <mark>"+year+"</mark>.\<br\>" // This prints out default messages depending on the input given
}
